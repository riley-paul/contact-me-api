/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b65c682895ace2658fb478c0cc9f8a09)
// Runtime types generated with workerd@1.20260603.1 2026-02-27 nodejs_compat
interface __BaseEnv_Env {
	RATE_LIMITER: RateLimit;
	DUPLICATE_LIMITER: RateLimit;
	NODE_ENV: string;
	SITE: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "SITE" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "RESEND_API_KEY">> {}
}
